    ...
    <Card>
      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="max-h-[200px] w-full">
            ...
            <Bar fill="var(--color-success)" fillOpacity={0.8} radius={[0,0,4,4]} stroke="var(--color-success)" stackId={'a'} dataKey={'success'} />
            <Bar fill="var(--color-failed)" fillOpacity={0.8} radius={[4,4,0,0]} stroke="var(--color-failed)" stackId={'b'} dataKey={'failed'} />
            </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
