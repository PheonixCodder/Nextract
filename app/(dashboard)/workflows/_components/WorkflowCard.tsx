  ...
  return (
    <Card className='border border-separate shadow-sm rounded-lg overflow-hidden hover:shadow-md dark:shadow-primary/30'>
        <CardContent className='p-4 flex items-center justify-between h-[100px]'>
            ...
            <div className={cn(
                'w-10 h-10 flex rounded-full items-center bg-red-500 justify-center', statusColors[workflow.status as WorkflowStatus]
            )}>
                {isDraft ? (
            ...
            <div>
                <h3 className='text-base font-bold text-muted-foreground flex items-center'>
                    ...
                    {isDraft && <span className='ml-2 px-2 py-0.5 text-xs font-medium bg-green-100 text-green-800 rounded-full'>Draft</span>}
                </h3>
            </div>
            </div>
